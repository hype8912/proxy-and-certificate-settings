...
| Arch Linux | Arch | archlinux:latest | 150MB | curl, unzip, [step-cli.rpm](https://dl.smallstep.com/cli/docs-ca-install/latest/step-cli_amd64.rpm)| `/etc/ca-certificates/trust-source/anchors/` | <pre lang="bash">update-ca-trust extract</pre> |
...
| Debian Linux | Debian | debian:stable-slim<br>ubuntu:latest | 27MB<br>28MB | ca-certificates, curl, unzip | `/usr/local/share/ca-certificates/` | <pre lang="bash">update-ca-certificates</pre> |
