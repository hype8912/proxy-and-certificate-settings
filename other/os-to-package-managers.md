...
| Arch Linux | [Aura](https://github.com/fosskers/aura)<br>[Pacman]()<br>[pacapt (dead)](https://github.com/icy/pacapt)<br>[pacaptr]()<br>[Trizen](https://github.com/trizen/trizen)<br>[Zap](https://github.com/srevinsaju/zap) |
...
|:---:|---|
| Darwin | See [Mac OS](#m) |
| Debian | [apt]()<br>[apt-get]()<br>[deb-get](https://github.com/wimpysworld/deb-get)<br>[dpkg]()<br>[Zap](https://github.com/srevinsaju/zap) |
...
| OS/Distro | Package Manager |
|:---:|---|
| Ubuntu | See [Debian](#d)<br>[Pacstall](https://github.com/fosskers/aura) |
