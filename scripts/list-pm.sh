...
pkmP="pacaptr pacman paket parn pdm pear petget pip pipenv pipflow pipx pixi pkg pkgm pkgtool plz pnpm pod poet poetry port portage ppm pyenv pym pypm"
pkmQ="qp qpkg"
pkmR="raco rpkg rpm rustup rut rye rzget"
pkmS="sbt scarb scoop slackpkg slapt-get snap spack spago stack swift swupd"
pkmT="tdnf teaport trex twine"
