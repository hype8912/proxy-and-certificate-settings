...
| wget | GNU Wget | alpine:latest | 4MB | `/etc/wgetrc` or `~/.wgetrc` file<pre><code class="language-properties">use_proxy = on&#13;http_proxy=$HTTP_PROXY&#13;https_proxy=$HTTPS_PROXY&#13;HTTP_PROXY=$HTTP_PROXY&#13;HTTPS_PROXY=$HTTPS_PROXY&#13;no_proxy=$NO_PROXY</code></pre> | `/etc/wgetrc` or `~/.wgetrc` file[^wget]<pre><code class="language-properties">ca_certificate=$SSL_CERT_FILE&#13;ca_directory=$SSL_CERT_DIR</code></pre> |
