...
| MAVEN_OPTS[^maven] | Maven | `-Djavax.net.ssl.trustStore=$SSL_KEYSTORE_FILE -Djavax.net.ssl.trustStorePassword={Password}` | `-Djavax.net.ssl.trustStore=%SSL_KEYSTORE_FILE% -Djavax.net.ssl.trustStorePassword={Password}` |
